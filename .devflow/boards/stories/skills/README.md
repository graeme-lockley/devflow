...
Phase exit skills for the stories workflow. Devflow scripts invoke `pi-mono`
with one skill per transition; shared rules live in
[_shared/harness.md](./_shared/harness.md).
