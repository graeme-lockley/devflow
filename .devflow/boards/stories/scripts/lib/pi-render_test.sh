...
assert_contains "$stderr" "bash: echo hello" "stderr contains bash tool call"
assert_contains "$stderr" "read: /tmp/test.md" "stderr contains read tool call"
assert_contains "$stderr" "tokens:" "stderr contains usage summary"
assert_not_contains "$stderr" '{"command":' "stderr does not contain raw JSON fragments"
assert_not_contains "$stderr" '{"path":' "stderr does not contain raw JSON fragments"
assert_not_contains "$stderr" '> bash:' "stderr does not contain > prefix"
assert_not_contains "$stderr" 'Executing bash' "stderr does not contain redundant Executing lines"
echo
...
assert_contains "$stderr" "bash: echo hello" "stderr contains bash tool call (verbose)"
assert_contains "$stderr" "read: /tmp/test.md" "stderr contains read tool call (verbose)"
echo
