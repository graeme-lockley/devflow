...
Records of significant implementation choices for Devflow. Behavioural requirements remain authoritative in [`../devflow-requirements.md`](../devflow-requirements.md).
...
Add a new ADR when a choice is hard to reverse, affects multiple modules, or is not fully specified in the requirements document. Do not duplicate requirement text; link to it.
