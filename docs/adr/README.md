...
| [0014](./0014-script-composition-and-loops.md)    | Script composition and phase loops (deprecated)  | Superseded |
| [0015](./0015-script-flow-control.md)             | Script flow control via `NEXT_SCRIPT`            | Accepted   |
